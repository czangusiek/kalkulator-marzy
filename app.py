...
class KalkulatorMarzyForm(FlaskForm):
    ...
    ilosc_sztuk = StringField('Ilość sztuk:', default="1", validators=[DataRequired()])
...
def index():
    ...
    if form_marza.submit.data and form_marza.validate():
        ...
        ilosc_sztuk = zamien_przecinek_na_kropke(form_marza.ilosc_sztuk.data)
    ...
    if form_vat.submit.data and form_vat.validate():
        ...
        ilosc_sztuk = zamien_przecinek_na_kropke(form_vat.ilosc_sztuk.data)
